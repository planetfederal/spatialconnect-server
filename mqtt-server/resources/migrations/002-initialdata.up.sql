...
INSERT INTO form_def (id,form_id,position,key,name,type,is_integer,is_required)
...
INSERT INTO form_def (id,form_id,position,key,name,type,initial_value)
...
INSERT INTO form_def (id,form_id,position,key,name,type,minimum,maximum,initial_value)
...
INSERT INTO form_def (id,form_id,position,key,name,type,minimum,initial_value,is_required)
...
INSERT INTO form_def (id,form_id,position,key,name,type,pattern,is_required)
VALUES ('783cb070-2383-11e6-8e69-199a71acc918',(SELECT id FROM forms WHERE name = 'Weed Inspector'),5,'source','Source','string','',true);

INSERT INTO form_def (id,form_id,position,key,name,type)
...
INSERT INTO form_def (id,form_id,position,key,name,type,pattern)
